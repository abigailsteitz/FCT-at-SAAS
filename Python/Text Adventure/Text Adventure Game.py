...
def lead(character):
    ...
    if character == "Elsa":
        ...
        print("")
        print("You die, but you saved seventeen people, and some others that saw what you were doing and hid too.")
    ...
    if character == "Elsa":
        ...
        while True:
            ...
            if elsaSoloRun == "1" or elsaSoloRun.lower() == "continue":
                ...
                print("")
                print("You have made it home from school alive! With a new group of admirers! Terrific!")
                print("")
