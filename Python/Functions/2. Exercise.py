...
#Show a welcome message and the prices of clothing items.
#Ask you to choose between pants or a skirt.
#Ask you to choose between a shirt or a tank top.
#Thank you and display "Thanks! Your total is:" but not show the total price because the add_numbers function is not called, and its return statement is commented out.
