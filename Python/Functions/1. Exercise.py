...
def greet(Barrett):
    print(f"Hello, {Barrett}! Thanks for coming to my birthday party!")
...
names = ["Barrett","Alice","Bob","Charlie"]  # Replace with your friends' names

# TODO: Task 3, use a for loop to iterate over the list of names and call the greet function for each name.
for name in names:
    greet(name)  # Call the greet function for each name in the list
